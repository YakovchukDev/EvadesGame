...
{
    public class EducationResultController : MonoBehaviour
    {
        [SerializeField] private EducationInterface _educationInterface;
        ...
        public IEnumerator ShowResult()
        {
            ...
            yield return new WaitForSeconds(0.2f);
            int stars = _educationInterface.CountGetStar;
            for (int i = 0; i < stars && i < _listStars.Count; i++)
            {
