...
namespace Menu.ScriptableObject.Information
{
    public class InformationController : MonoBehaviour
    {
        ...
        [Tooltip("Position for spawn")] [SerializeField]
        private Transform _spawnGamePlayPosition;
        ...
        [SerializeField] private List<InfoPanel> _infoGamePlayPanels;
        ...
        private void Awake()
        {
            ...
            PanelSpawner(_spawnGamePlayPosition, _infoGamePlayPanels,_infoPrefab);
        }
